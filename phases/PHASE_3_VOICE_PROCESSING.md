...
- [ ] VoiceParser extracts exercise, weight, reps, RPE
- [ ] ExerciseResolver matches to database (3-tier search)
- [ ] Voice FAB component renders on START screen
- [ ] Keyboard input modal works for testing
- [ ] Typing "bench press 225 for 10" logs set correctly
- [ ] Workout store updates with new set
- [ ] Playwright tests pass
- [ ] Unit tests for VoiceParser pass
