  ...
  async startListening(): Promise<void> {
    try {
      ...
      await Voice.start('en-US', {
        ...
        EXTRA_SPEECH_INPUT_COMPLETE_SILENCE_LENGTH_MILLIS: 10000, // 10s silence = done (user finished speaking)
        EXTRA_SPEECH_INPUT_POSSIBLY_COMPLETE_SILENCE_LENGTH_MILLIS: 3000, // 3s pause = might be done (show partial)
      });
